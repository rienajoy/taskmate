    ...
    <x-authentication-card>
        ...
        <form method="POST" action="{{ route('login') }}">
            ...
            <div>
                ...
                <x-input id="email" class="block mt-1 w-full border-blue-300" type="email" name="email" :value="old('email')" required autofocus autocomplete="username" />
            </div>
            ...
            <div class="flex items-center justify-end mt-4">
                ...
                <x-button class="ms-4 focus-ring-blue">
                    {{ __('Log in') }}
                </x-button>
            </div>
        </form>
